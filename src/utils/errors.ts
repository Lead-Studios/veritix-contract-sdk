...
function buildMessage(code: VeriTixErrorCode, rawStr: string): string {
  const messages: Record<VeriTixErrorCode, string> = {
    ...
    [VeriTixErrorCode.InvalidAddress]:              'Supplied address is not a valid Stellar account address or Ed25519 public key.',
    ...
    [VeriTixErrorCode.WatchTimeout]:                'watchTransaction() or watchEscrow() timed out.',
